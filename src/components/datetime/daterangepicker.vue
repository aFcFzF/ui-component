<template>
    <div :class="dateCls">
        ...
        <div class="ui-date-container ui-date-range-container" v-if="isShow">
            <div v-if="shortcuts.length>0"
                class="ui-date-shortcut">
        ...
        <div class="ui-date-footer">
            <button class="ui-btn ui-btn-text ui-btn-xs"
...
export default {
    ...
    computed: {
        ...
        show() {
            ...
            return `${this.value.start || '开始时间'} - ${this.value.end || '结束时间'}`;
        },
        shortcuts() {
            let shortcuts = [];
